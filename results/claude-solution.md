...
| Child commit evaluated | `b102146` |
| Parent commit (spec + evals) | `834dd1f` |
| Fixture | `./evals/fixtures/.private/hidden-v2` @ run-date 2026-09-18 |
| Evaluated at | 2026-09-23T01:56:46.325Z |
...
| ✅ | install |  added 147 packages, and audited 148 packages in 4s  21 packages are looking for funding   run `npm fund` for details  2 moderate severity vulnerabilities  To address all issues (including breaking changes), run:   npm audit fix --force  Run `npm audit` for details.  |
| ✅ | npm test passes offline, no .env | reach-policy.test.ts [2m([22m[2m7 tests[22m[2m)[22m[33m 850[2mms[22m[39m    [33m[2m✓[22m[39m outreach policy (spec section 6)[2m > [22mfirst contact, follow-up window, max follow-ups, then escalation to the dashboard [33m 374[2mms[22m[39m  [32m✓[39m tests/unit/pause.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 81[2mms[22m[39m  [2m Test Files [22m [1m[32m19 passed[ |
| ✅ | pipeline run 1 exits 0 | ":{"sites_created":11,"listings_merged":2}} {"level":"info","msg":"stage start","at":"2026-09-23T01:56:54.544Z","run_id":"run_df41931c7ec9ceaa","stage":"enrich"} {"level":"info","msg":"stage done","at":"2026-09-23T01:56:54.557Z","run_id":"run_df41931c7ec9ceaa","stage":"enrich","counts":{"drivetime_fetched":11,"rent_from_listing":8,"zoning_permitted_by_table":7,"flood_fetched":10,"traffic_fetched": |
| ✅ | report.json written |  |
...
| ✅ | pipeline run 2 exits 0 | l":"info","msg":"stage done","at":"2026-09-23T01:56:55.244Z","run_id":"run_c4cff43236d9c387","stage":"verify","counts":{"groups_within_followup_window":2,"inbound_already_ingested":2}} {"level":"info","msg":"stage start","at":"2026-09-23T01:56:55.244Z","run_id":"run_c4cff43236d9c387","stage":"score"} {"level":"info","msg":"stage done","at":"2026-09-23T01:56:55.246Z","run_id":"run_c4cff43236d9c387" |
...
| ✅ | dashboard:build offline | 2,"zoning_prohibited_by_table":1,"sites_out_of_area":1}} {"level":"info","msg":"stage start","at":"2026-09-23T01:56:57.537Z","run_id":"run_7a63d39f8b110e30","stage":"verify"} {"level":"info","msg":"stage done","at":"2026-09-23T01:56:57.542Z","run_id":"run_7a63d39f8b110e30","stage":"verify","counts":{"cases_opened":3,"messages_sent":3,"cases_resolved_by_reply":2,"inbound_ingested":2}} {"level":"inf |
...
| Install time | 3.8 s |
| Test time | 3.3 s |
| Test summary | 19 passed |
| Pipeline time (run 1) | 0.8 s |
| Dashboard build time | 3.0 s |
| Type-check clean | yes |
| Source files / test files | 69 / 19 |
| Source lines | 9595 |
| Dependencies / dev | 5 / 7 |
| Commits | 46 |
| First to last commit | 149.85 h |
